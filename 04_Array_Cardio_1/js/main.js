...
const bornInFifteenHundred = inventors.filter(inventor => (inventor.born >= 1500 && inventor.born < 1600));
...
const sortedByBirthdate = inventors.sort((a, b) => a.born > b.born ? 1 : -1);
console.table(sortedByBirthdate);

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const livedYears = inventors.reduce((total, inventor) => (total + (inventor.passed - inventor.born)), 0);
console.log(`Lived years: ${livedYears}`);

// 5. Sort the inventors by years lived
const sortedByYearsLived = inventors.sort((a, b) => (a.passed - a.born) > (b.passed - b.born) ? -1 : 1);
